...
export const setupHooks = ({web3, provider, contract, connectedAccount}) => {
    return {
        useAccount: createAccountHook(web3, provider),
        useNetwork: createNetworkHook(web3),
        useSupplyAssets: createSupplyAssetsHook(web3, contract, connectedAccount),
        useBorrowAssets: createBorrowAssetsHook(web3, contract, connectedAccount),
        useYourSupplies: createYourSuppliesHook(web3, contract, connectedAccount),
        useYourBorrows: createYourBorrowsHook(web3, contract, connectedAccount)
